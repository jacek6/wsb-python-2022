...
class ListaRzeczyDoZrobienia:
    ...
    def dodaj_rzecz_do_zrobienia(self):
        self.lista.append(self._spytaj_o_rzecz_do_zrobienia())

    def _spytaj_o_rzecz_do_zrobienia(self):
        return input('Podaj co chcesz zrobić: ')
...
class ZakazaneRzeczyDoZrobienia(ListaRzeczyDoZrobienia):
    ...
    def _spytaj_o_rzecz_do_zrobienia(self):
        rzecz_do_zrobienia_z_klasy_rodzica = super(ZakazaneRzeczyDoZrobienia, self)._spytaj_o_rzecz_do_zrobienia()
        return f'{rzecz_do_zrobienia_z_klasy_rodzica} - ale nie wolno'
